...
public class Lemming {
  ...
  /** this is an attribute of the lemming, not necesarily curently being executed */
   ...
   */
  public Lemming(int xPos, int yPos, BufferedImage mask, BufferedImage levelImg) {
    this.mask = mask;
    this.level = levelImg;
    this.xPos = xPos;
    this.yPos = yPos;
  ...
  public void init() {
    ...
    try {
      ...
      rightMid = javax.imageio.ImageIO.read(getClass().getResource("rightMid.png"));
      rightFront = javax.imageio.ImageIO.read(getClass().getResource("rightFront.png"));
      rightBack = javax.imageio.ImageIO.read(getClass().getResource("rightBack.png"));
      leftMid = javax.imageio.ImageIO.read(getClass().getResource("leftMid.png"));
      leftFront = javax.imageio.ImageIO.read(getClass().getResource("leftFront.png"));
      leftBack = javax.imageio.ImageIO.read(getClass().getResource("leftBack.png"));

      rightMidClimb = javax.imageio.ImageIO.read(getClass().getResource("rightMidClimb.png"));
      rightFrontClimb = javax.imageio.ImageIO.read(getClass().getResource("rightFrontClimb.png"));
      rightBackClimb = javax.imageio.ImageIO.read(getClass().getResource("rightBackClimb.png"));
      leftMidClimb = javax.imageio.ImageIO.read(getClass().getResource("leftMidClimb.png"));
      leftFrontClimb = javax.imageio.ImageIO.read(getClass().getResource("leftFrontClimb.png"));
      leftBackClimb = javax.imageio.ImageIO.read(getClass().getResource("leftBackClimb.png"));

      digImgL = javax.imageio.ImageIO.read(getClass().getResource("digLeft.png"));
      digImgR = javax.imageio.ImageIO.read(getClass().getResource("digRight.png"));
      blockerImg = javax.imageio.ImageIO.read(getClass().getResource("blocker.png"));
      fallingImgR = javax.imageio.ImageIO.read(getClass().getResource("fallingDownRight.png"));
      fallingImgL = javax.imageio.ImageIO.read(getClass().getResource("fallingDownLeft.png"));

      floatImg = javax.imageio.ImageIO.read(getClass().getResource("floater.png"));

      die1 = javax.imageio.ImageIO.read(getClass().getResource("die1.png"));
      die2 = javax.imageio.ImageIO.read(getClass().getResource("die2.png"));
      die3 = javax.imageio.ImageIO.read(getClass().getResource("dead.png"));
  ...
  public void dig() {
    ...
    if (getBottomColor(0) == (Color.red).getRGB()) {
      ...
      for (int j = 0; j < curImage.getWidth(); j++) {
        ...
        if (getLeftColor() != (Color.red).getRGB() || getRightColor() != (Color.red).getRGB()) {

          level.setRGB(xPos + j, yPos + (2 * yOffset), levelColor);

          level.setRGB(xPos + j, yPos + (2 * yOffset) + 1, levelColor);

          level.setRGB(xPos + j, yPos + (2 * yOffset) + 2, levelColor);

          mask.setRGB(xPos + j, yPos + (2 * yOffset), digColor);

          mask.setRGB(xPos + j, yPos + (2 * yOffset) + 1, digColor);

          mask.setRGB(xPos + j, yPos + (2 * yOffset) + 2, digColor);
    ...
    if ((Color.black).getRGB() != getBottomColor(0)) {
      ...
      for (int i = 0; i < yOffset; i++) {
        ...
        for (int j = 0; j < xOffset; j++) {
          ...
          mask.setRGB(xPos + j, yPos + i, (Color.green).getRGB());
        }
      }
    }
  }
  ...
  public void climb(boolean rightDirLoc) {
    ...
    if ((Color.black).getRGB() != getTopColor()) {
      ...
      if (rightDirLoc) {
        ...
        setYPos(getYPos() - (curImage.getWidth() - curImage.getHeight()) - 5);
  ...
  public boolean bashable(boolean rightDirLoc, int bashLen) {
    ...
    if (rightDirLoc) {
      ...
      wallColor =
          mask.getRGB(xPos + curImage.getWidth() + bashLen, yPos + curImage.getHeight() - 4);

    } else {

      wallColor = mask.getRGB(xPos - bashLen, yPos + curImage.getHeight() - 4);
    }
      ...
      if (rightDirLoc) {
        ...
        for (int i = backSet; i <= (xOffset / 4); i++) {
          ...
          for (int j = 0; j < yOffset; j++) {
            ...
            mask.setRGB(xPos + xOffset + i, yPos + j, (Color.black).getRGB());
          }
        }
        ...
        for (int i = backSet; i <= (xOffset / 4); i++) {
          ...
          for (int j = 0; j < yOffset; j++) {
            ...
            level.setRGB(xPos - i, yPos + j, levelColor);

            mask.setRGB(xPos - i, yPos + j, (Color.black).getRGB());
          }
        }
      }
  ...
  public void mine() {
    ...
    if (getBottomColor(0) == (Color.red).getRGB()) {
      ...
      if (rightDir) {
        ...
        g2LocLevel.fillRect(xPos - xOffset + 10, yPos - 5, 20, yOffset * 2);
        g2LocMask.fillRect(xPos - xOffset + 10, yPos - 5, 20, yOffset * 2);
    ...
    if (!(climbable(rightDir)) && (Color.black).getRGB() == getTopColor()) {
      ...
      if (climbCounter < 32) {
        ...
        if (rightDir) {
          ...
          g2LocLevel.fillRect(xPos + xOffsetLoc / 2, yPos + yOffsetLoc - 4, xOffsetLoc / 2, 12);

          g2LocMask.fillRect(xPos + xOffsetLoc / 2, yPos + yOffsetLoc - 4, xOffsetLoc / 2, 12);

        } else {

          g2LocLevel.fillRect(xPos, yPos + yOffsetLoc - 4, xOffsetLoc / 2, 12);

          g2LocMask.fillRect(xPos, yPos + yOffsetLoc - 4, xOffsetLoc / 2, 12);
        }
  ...
  public boolean exited() {
    ...
    lemmingExited =
        ((Color.blue).getRGB() == getLeftUpColor() || (Color.blue).getRGB() == getRightUpColor());
  ...
  /** @return boolean telling if exploding death is enabled */
  ...
  /**
   * sets the lemming to pause and wait for input.
   *
