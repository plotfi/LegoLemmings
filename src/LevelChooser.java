 ...
 * This class reads from the file levelChooser.txt and uses the info therein
 * to get data on each of the levels, in order.
 *
 * (instructions on the format of the file can be found in the sample)
 */
public class LevelChooser {
   ...
   /**
    * This function reads in and interprets the data.
    * This function reads in and interprets the data from the file.
    */
    public LevelChooser() {
        levels = new Stack();
        File levelText;
...
/*abilities:*/  Stack abilities = new Stack();
                ...
                start = new Point(x, y);
                levels.addElement(new LevelData(levelName, lems, rate, goal, 
                                  time, start, tempStack));
            }
            readFrom.close();
        } catch (IOException e) {
   ...
   /**
    * This function gets the data for the selected level.
    * This function gets the data for the selected level.
    *
