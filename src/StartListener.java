...
/** This class watches the start screen for input. This class watches the start screen for input. */
public class StartListener implements MouseListener, KeyListener, MouseMotionListener {
  ...
  /**
   * The constructor sets the canvas to watch. The constructor sets the canvas to watch.
   *
  ...
  /**
   * handles when the mouse is clicked. handles when the mouse is clicked.
   *
  ...
  public void mouseClicked(MouseEvent e) {
    ...
    if (inMulti) {
      ...
      if (x > 250 && x < 350) {
        if ((lvl = (y - 200) / 20) >= 0 && lvl < window.getlChooser().getLevelCount()) {
      ...
      if (x > 100 && x < 200) {
        if ((lvl = (y - 100) / 20) >= 0 && lvl < window.getlChooser().getLevelCount()) {
          window.previewLevel(lvl);
          choselvl = lvl;
        }
      }
  ...
  /**
   * This function is only here to make Mouse Listener happy. This function is only here to make
   * Mouse Listener happy.
   *
  ...
  /**
   * This function handles key input. This function handles key input.
   *
  ...
  /**
   * This function is only here to make Key Listener happy. This function is only here to make Key
   * Listener happy.
   *
   * @param e the mouse event.
   */
  ...
  /**
   * This function is only here to make Mouse Motion Listener happy. This function is only here to
   * make Mouse Motion Listener happy.
   *
   * @param e the mouse event.
   */
