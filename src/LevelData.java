...
/**
 * This class stores data on the levels.
 * This class stores data on the levels.
 */
public class LevelData {
    ...
    /**
     * This constructor calls the other to make a basic level.
     * This constructor calls the other to make a basic level.
     */
    public LevelData() {
   ...
   /**
    * The Constructor sets up the variables.
    * The Constructor sets up the variables.
    *
    ...
    */
    public LevelData(String name, int count, int rate, int goal, 
                 int time, Point start, Stack abilities) {
        fileName = name;
        lemmingCount = count;
        releaseRate = rate;
        lemmingGoal = goal;
   ...
   /**
    * This function sets the Start Point
    * This function sets the Start Point
    *
   ...
   /**
    * This function gets the Release Rate
    * This function gets the Release Rate
    *
   ...
   /**
    * This function gets the Start Position
    * This function gets the Start Position
    *
   ...
   /**
    * This function gets the Ability info
    * This function gets the Ability Info
    *
