...
//        bufferStrategy.show();
    ...
    */
    public void levelStats(int lvlNum) {
        ...
        Stack sort = (Stack) lchooser.getLevelData(lvlNum)
                                     .getAbilityData().clone();
   ...
   /** 
    * Host or connect?
    * this function shows the screen where you pick either
    *  to host or connect to a multiplayer game.
    */
    public void setupMulti() {
        ...
        g.drawString("Please Select if you will be hosting or connecting.", 
                     200, 100);
        g.setFont(new Font(null, Font.PLAIN, 14));
   ...
   /**
    * this function shows the window for starting a multiplayer game.
    * this function shows the window for starting a multiplayer game.
    */
   ...
   /**
    * this function shows the window for connecting to a multiplayer game.
    * this function shows the window for connecting to a multiplayer game.
    */
   ...
   /**
    * after the level, show if you won or lost.
    * after the level, show if you won or lost.
    */
...
//show stats, check to see if proceed to next level.
    ...
    */
    public void startLevel(int lvlNum) {
        ...
        runLevel = new Level(this, frame, data, 0, 0, 
                 (Stack) data.getAbilityData().clone(), null);
   ...
   /**
    * display a miniture version of the map.
    * display a miniture version of the map.
    *
        ...
        try {
            BufferedImage miniMap = 
                javax.imageio.ImageIO.read(getClass().getResource(
                      lchooser.getLevelData(lvl).getFile() + ".png"));
   ...
   /**
    * this function returns the level chooser.
    * this function returns the level chooser.
    *
   ...
   /**
    * This function returns the window to make the level in.
    * This function returns the window to make the level in.
    *
    * @return the window.
    */
   ...
   /**
    * this function sets the port number.
    * this function sets the port number.
    *
   ...
   /**
    * This functionr returns the host Name.
    * This functionr returns the host Name.
    *
   ...
   /**
    * This function sets the host to connect to.
    * This function sets the host to connect to.
    *
   ...
   /**
    * start multiplayer for the client.
    * start multiplayer for the client.
    */
    public void startMultiPlayerClient() {
        ...
        frame.removeKeyListener(slistener);
        runLevel = new Level(this, frame, data, 0, 0, 
                       (Stack) data.getAbilityData().clone(), pclient);
    }  

   /**
    * start multiplayer for the server.
    * start multiplayer for the server.
    */
    public void startMultiPlayerServer() {
        ...
        frame.removeKeyListener(slistener);
        runLevel = new Level(this, frame, data, 0, 0, 
                       (Stack) data.getAbilityData().clone(), servclient);
    }

   /**
    * after the level, display the stats for a multiplayer game.
    * after the level, display the stats for a multiplayer game.
    */
...
//show stats, check to see if proceed to next level.
   ...
   /**
    * The Main function.
    * This function starts it all up.
    *
