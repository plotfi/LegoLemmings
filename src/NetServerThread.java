...
/**
 * The class regarding our server's thread. It extends thread so it can utilize the actual threading
 * that gets done, making it easier for us. The threads pertain to individual clients that connect
 * to the server.
 */
public class NetServerThread extends Thread {
  ...
  /**
   * The main function of our server threading class. This reads the commands the users and the
   * admin supply as well as displays messages to the server.
   */
  public void run() {
