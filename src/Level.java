...
public class Level implements Runnable {
  ...
  /** The List of lemmings. The List of lemmings. */
  private List lemmings = new Vector();

  /** The background image. The background image. */
  private BufferedImage bgImage;

  /** The image mask. The image mask. */
  private BufferedImage mask;

  /** The image of buttons. The image of buttons. */
  ...
  /** The abilities available for this level, and the number of uses for each. */
  ...
  public Level(
    ...
    try {
      ...
      frame.setIconImage(javax.imageio.ImageIO.read(getClass().getResource("lemIcon.png")));

      bgImage = javax.imageio.ImageIO.read(getClass().getResource(levelName + ".png"));

      mask = javax.imageio.ImageIO.read(getClass().getResource(levelName + "mask.png"));

      buttons = javax.imageio.ImageIO.read(getClass().getResource("toolbar.png"));
  ...
  /** This method does animation. The run method handles image all animation. */
  public void run() {
    ...
    while (running) {
      ...
      g2.drawImage(
          ...
          txoffset,
          tyoffset,
          (int) (scale * bgImage.getWidth()),
          (int) (scale * bgImage.getHeight()),
          null);
      ...
      for (int i = 0; i < lemmings.size(); i++) {
        ...
        g2.drawImage(
            currentLemming.getCurImage(),
            xtem,
            ytem,
            (int) (currentLemming.getCurImage().getWidth() * scale),
            (int) (currentLemming.getCurImage().getHeight() * scale),
            null);
      ...
      g2.drawRect(
          (int) (mxoff - txoffset * 100 / scale / mask.getWidth()),
      ...
      for (int j = 0; j < lemmings.size(); j++) {
        ...
        g2.fillOval(
            currentLemming.getXPos() * 100 / mask.getWidth() + mxoff,
            (currentLemming.getYPos() + 10) * myh / mask.getHeight() + myoff,
            2,
            2);
      }
      ...
      g2.drawString(
          " " + timeString / 60 + ":" + (timeString % 60) / 10 + (timeString % 60) % 10, 750, 35);
      ...
      if (isMulti) {
        ...
        netInfo.sendStats(lemCount, currCount, saved, lemCount - currCount, false);
      }
      if (showAbout) {
        drawAbout();
      }
  ...
  /**
   * This function sets the paused variable. this function pauses the game.
   *
  ...
  /**
   * this function tells you if the game is paused. this function returns the paused variable.
   *
  ...
  /**
   * this function moves the image in the X direction. this function adds a displacement to the
   * image.
   *
  ...
  /**
   * this function moves the image in the Y direction. this function adds a displacement to the
   * image.
   *
   * @param in how far to displace it.
   */
  ...
  /**
   * This function returns the height of the frame. this function returns the height of the frame.
   *
  ...
  /**
   * This function returns the list of lemmings. This function returns the List of lemmings.
   *
  ...
  /**
   * This function returns the X offset. this function returns the X offset.
   *
   * @return the X offset.
   */
  ...
  /**
   * This function returns the Y offset. this function returns the Y offset.
   *
   * @return the Y offset.
   */
  ...
  /**
   * This function changes the rate of release. This function adds a given input to the rate of
   * release, while keeping it in the bounds of 1-99.
   *
  ...
  /** This function displays the help screen. This function displays the help screen. */
  public void displayHelp() {
    showHelp = true;
  }

  /** This function draws the help screen. This function draws the help screen. */
  public void drawHelp() {
    ...
    g2.drawString("The goal of this game is to save all of the " + "lemmings.", 305, 90);
    g2.drawString(
        "The tool bar above includes information on " + "how many lemmings have been saved,",
        305,
        105);
    g2.drawString(
        "how many are left to save, and how much time " + "is left to save them in.", 305, 120);
    g2.drawString(
        "The tool bar at the bottom allows you to " + "select abilities to give the lemmings,",
        305,
        135);
    g2.drawString(
        "as well as the ability to increase their " + "release rate and a mini-map of the level.",
        305,
        150);
    g2.drawString(
        "To give a lemming an ability, select the " + "ability, and then select the lemming you",
        305,
        165);
    g2.drawString("want to have that ability. ", 305, 180);
    g2.drawString("Beware: you have a limited number of uses " + "for each ability.", 305, 195);
    ...
    g2.drawString("'-'/'=' decrease/ increase the rate of " + "release of the lemmings.", 305, 265);
    g2.drawString("the arrow keys, and the mouse scroll wheel*, " + "scroll the level.", 305, 280);
    g2.drawString("'F1' / 'F2' zoom in and out.", 305, 295);
    g2.drawString(
        "*normally the level scrolls with the wheel, " + "but by holding down the shift key, ",
        305,
        325);
  ...
  /** This function displays the about screen. This function displays the about screen. */
  public void displayAbout() {
    showAbout = true;
  }

  /** This function draws the About Screen. This function draws the About Screen. */
  ...
  /**
   * whether or not the game is still running. whether or not the game is still running.
   *
  ...
  /**
   * This function returns the number of saved lemmings. This function returns the number of saved
   * lemmings.
   *
  ...
  /**
   * This function says the user wants to nuke his lemmings. This function says the user wants to
   * nuke his lemmings.
   */
  public void nukeEm() {
    nuke = true;
  ...
  /**
   * This function zooms the window. This function zooms the window.
   *
  ...
  /**
   * This function returns the current scalara multiplier. This function returns the current scalara
   * multiplier.
   *
