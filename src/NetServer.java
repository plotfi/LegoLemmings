...
/**
 * The backbone of the server. This class is the actual server that listens for threads, broadcasts
 * messages, and opens the socket port.
 */
public class NetServer {
  ...
  /**
   * This function starts the server. This function starts the server.
   *
   * @throws IOException The exception that the main function can throw is an Input/Output
   *     exception.
   */
  ...
  /** This function closes the connection. This function closes the connection. */
  public void end() {
    try {
      serverSocket.close();
    } catch (IOException e) {
  ...
  /**
   * This function broadcasts messages in a server so that all of the clients can read it.
   *
