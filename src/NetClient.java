...
/**
 * This is the main server class, all threads for the serve are launched from this class. Also, a
 * server handler will me implemented from this class or a thread this one spawns.
 */
public class NetClient {

  /** This is the server socket for the connection between the client and the server. */
  ...
  /**
   * This constructor sets variables This constructor sets variables
   *
  ...
  /**
   * This function starts the client in serving mode. This function starts the client in serving
   * mode.
   *
  ...
  /**
   * This function starts the Client up. This function starts the Client up.
   *
   * @throws IOException yeah it does, for when you can't connect to the server.
   */
  public static void start() throws IOException {
    ...
    listenForMsgs = new NetClientThread(clientSocket, in, user);

    listenForMsgs.start();
  }

  /**
   * this sends string messages to the server. which converts then into objects.
   *
  ...
  /**
   * this sends the statistics. this sends the statistics.
   *
   * @param rel released.
   ...
   */
  public static void sendStats(int rel, int outint, int sav, int dead, boolean nuke) {
